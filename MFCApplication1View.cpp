...
BEGIN_MESSAGE_MAP(CMFCApplication1View, CView)
	...
	ON_WM_PAINT()
	ON_WM_MOUSEMOVE()
	ON_COMMAND(ID_TEST123, &CMFCApplication1View::OnTest123)
END_MESSAGE_MAP()
...
void CMFCApplication1View::OnLButtonDown(UINT nFlags, CPoint point)
{
	...
	MyStruct a = {};
	MyStruct b = {};
	a.x = 1; a.y = 2; a.z = 3; a.normV[0][0] = 1; a.normV[1][0] = 2; a.normV[2][0] = 3; a.normV[3][0] = 4;
	b.x = 4; b.y = 5; b.z = 6;
	NewStruct ns;
	ns.ptr[0] = a;
	ns.ptr[1] = b;
...
void CMFCApplication1View::OnTest123()
{
